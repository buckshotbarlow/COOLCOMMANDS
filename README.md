...
Remove Rocky Linux 10 desktop bloat
  ...
  [!TIP] Remove unnecessary desktop packages:
...
Remove unused firmware (optional)
  ...
  [!CAUTION] Removing firmware packages can break hardware support. Only
  do this if you have confirmed the hardware does not need them.
